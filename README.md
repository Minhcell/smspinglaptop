...
5. Giải nén file zip em gửi ra máy, kéo thả **toàn bộ nội dung bên trong thư mục `VTV_SMS_Ping`** (không kéo cả thư mục cha) vào khung upload — kéo cả file lẫn các thư mục con như `.github`
...
2. Kéo xuống dưới cùng trang, thấy mục **Artifacts** > bấm vào **VTV_SMS_Ping-exe** để tải về (file .zip)
3. Giải nén ra, bên trong có file **VTV_SMS_Ping.exe**

### Bước 4: Chạy trên laptop
1. Copy cả thư mục vừa giải nén (không chỉ file .exe, cần đủ các file .dll đi kèm) vào laptop muốn dùng
2. Double-click **VTV_SMS_Ping.exe** để chạy
